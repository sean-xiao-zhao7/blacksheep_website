export default function LearnMore() {
    return <div className='text-page-container'>
        ...
        <div>
            ...
            <p>Only after connecting with the first community, if you find that they're not really your cup of tea, only then can you dismiss that community from your search and then the system matches you with the next nearest community near you.</p>
